...
delayed LIF spectrum of both $S_1$ sublevels, $3^36^1$ \Ka{0} and
$3^34^1$ \Ka{0}.  Because the line splittings appear with greater
...
mediated by specific levels of the $T_3$ electronic state \TODO{cite}.
...
The strong line splittings observed in the spectrum of $3^36^1$ \Ka{0}
and $3^34^1$ \Ka{0} place us squarely in these latter circumstances.
...
were able to do with the spectrum of $3^3$ \Ka{2}, Chapter 4.5.4.
...
In the spectrum of $3^34^1$ \Ka{0}, all observed line splittings are
...
to the nominal $S_1$ state energy, in $S_1$ $3^36^1$ \Ka{0}.
...
Table \ref{table:lif-variances}.  \TODO{Make table.}
...
of the doorway is likely to be positive for the $3^36^1$ \Ka{0}
sublevel and negative for the $3^34^1$ \Ka{0} sublevel.  This places
both $T_3$ doorway states at a total energy between 45937.8 \rcm\ and
46017.57 \rcm.  Since the $3^34^1$ \Ka{0} and $3^36^1$ \Ka{0}
...
\Ka{0} and $3^34^1$ \Ka{0}.  The allowed vibrational symmetries of
...
interference effects, as observed in $S_1$ $3^3$ \Ka{1}.  Interference
...
intramolecular vibrational redistribution \TODO{cite}.  The energy
spacings are expected to be highly regularized in the limit of total
mixing (GOE) \TODO{cite}.
...
\TODO{Discuss the relative magnitudes of $S_1 \sim T_3$ mixing in
  ...
  observations and ab inito predictions predict a stationary phase
  point close to the seam of intersection in the half-linear geometry,
  accessed by a combination of modes 3 and 6.  The ab inito
  calculations also predict that the $S_1 \sim T_3$ seam of
  intersection in the torsional coordinate occurrs on the WRONG SIDE
