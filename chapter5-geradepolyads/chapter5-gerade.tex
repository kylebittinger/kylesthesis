...
(3mm diameter) to form a collimated molecular beam in the SEELEM
...
where the total number of electrons was summed.
...
spectra were recorded with a 4$\times$ smaller step size.  The typical
signal level for SEELEM detection of acetylene was 2-20 counts per
laser pulse.

\section{LIF/SEELEM spectroscopy of four near-isoenergetic $S_1$
  vibrational levels}

\TODO{Use a consistent, known window for delayed fluorescence in each
  spectrum.  Specify this in figure captions.}

\TODO{Point out what is unique about each level in the figure
  caption.}
