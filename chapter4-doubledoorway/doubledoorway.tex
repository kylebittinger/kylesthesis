...
\usepackage{lgrind, amsmath, amssymb, longtable, booktabs, subfig, color}
...
% \begin{quote}
%   Make a comparison to the Au:SEELEM data from our own lab, with
%   integrated intensities out to $J' = 7$. 
% \end{quote}

% [Figure: integrated LIF + SEELEM intensities from our data.]
