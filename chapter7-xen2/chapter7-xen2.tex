...
nm) may be measured to observe the preparation of metastable \ce{N2}.
...
\ce{N2} $B \; ^3\Pi_g \rightarrow A \; ^3\Sigma_u^+$ emission in the visible
...
of \ce{N2} $B \; ^3\Pi_g \rightarrow A \; ^3\Sigma_u^+$ emission, which is on the
...
\rightarrow 6\;^3P_2$ and \ce{N2} $B \; ^3\Pi_g \rightarrow A \; ^3\Sigma_u^+$
...
\begin{figure}
  \caption{Time dependence of \ce{Xe} $6\;^3D_2 \rightarrow 6\;^3P_2$
    (top plot) and \ce{N2} $B \; ^3\Pi_g \rightarrow A \; ^3\Sigma_u^+$ (bottom
    ...
    in the visible region of the spectrum. \TODO{Change voltage to
      current.}}
...
Collisions between \ce{N2} molecules facitilate energy transfer
