...
demonstrate the general principles of the technique for the \ce{Xe}* +
\ce{N2} system, and then report progress on \ce{Hg}* + \ce{C2H2}.
...
250\degrees\ C, corresponding to a mercury vapor pressure of \TODO{Get
  Hg vapor pressures from lab} Torr.  A diagram of the ``Bern Valve''
...
two-step excitation, \TODO{Finish}
