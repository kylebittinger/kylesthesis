...
the doorway level included.  \TODO{Estimate total variance from
  $\alpha, \Delta E$ when doorway is not observed.}  Therefore, in the
event that the doorway is not observed in the spectrum, the variance
of the LIF spectrum may be used as a lower bound estimate for $H_{s
  \ell}^2$.
