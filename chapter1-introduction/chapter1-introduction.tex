...
In a Zeeman anticrossing experiment, the frequency of an excitation
...
mixed.  Under these circumstances, %half the molecules excited in the
%experiment decay by collision instead of fluorescence, and 
...
rule is Wodke's experiments on the \ce{NO} molecule, where vibrations
...
chemical systems, \ce{Xe}* + \ce{N2} and \ce{Hg}* + \ce{C2H2}.
